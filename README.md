...
The bounded-c1 and exact-tail candidates failed their respective fixed validation
gates; the 200k exact-tail run failed 80/720 decisions. Those inspected cases are
