...
def test_extract_nested_belief_hierarchy_level3(tmp_path):
    ...
    plot_nested_belief_sunburst(
        data, title="Test Sunburst", save_dir=str(tmp_path), filename="test_sb"
    )
    ...
    plot_episode_sunburst_slider(
        snapshots, title_prefix="Test Animated", save_dir=str(tmp_path), filename="test_anim"
    )
...
def test_sunburst_slice_position_stability(tmp_path):
    ...
    fig = plot_episode_sunburst_slider(
        snapshots, title_prefix="Stability Test", save_dir=str(tmp_path), filename="stability_test"
    )
