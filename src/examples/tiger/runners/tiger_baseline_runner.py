# Absolute Path: <project_root>/examples/tiger/runners/tiger_baseline_runner.py
...
class TigerBaselineRunner(GenericBatchRunner):
    ...
    [BIG-TECH REFACTOR]: Fully removed the legacy `_patch_planner` logic.
    The generic logging infrastructure now robustly supports agents without MCTS roots.
    """
...
if __name__ == "__main__":
    ...
    logger.info(f"Initializing Tiger Baseline Runner...")
