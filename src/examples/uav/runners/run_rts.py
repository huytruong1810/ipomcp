...
class UAV_RTS_Runner(GenericBatchRunner):
    """
    Evaluates exact branching Reachability Tree Sampling (RTS) baseline against I-POMCP.
    """
    ...
    def _setup_domain(self):
        ...
        # 2. UAV (I) uses RTS exact branching baseline with isolated SolverBank
        ...
        planner_i = boot_i.create_level2_rts_solver(
            'i', UAVModel(), ['j'],
            config=rts_cfg
        )
