...
Final verification of this implementation: all 217 tests passed in 303.62s,
including domain integration; Ruff lint/format and diff whitespace checks passed.
The 18-case L2 smoke also passed source-hash, coverage, contract metadata and
worker-interval concurrency checks. No production default was changed.
